...
scheduler.add_job(
    ...
    trigger=CronTrigger(hour=10, minute=00),  # Tous les jours à 16h40
    id='daily_scraping',
    name='Extraction quotidienne des prix à 10:00',
    replace_existing=True
)
scheduler.start()
logger.info("⏰ Scheduler initialisé: extraction quotidienne à 10:00  (heure locale du serveur)")
